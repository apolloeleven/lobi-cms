...
$(function(){
     ...
     */
    $(document).on('click', LobiAdminConfig.composeEmailViewSelector, function(){
        var $this = $(this);
        //If lobimail is already loaded
        if (window.location.hash === $this.attr('href')) {
            var $mail = $('.lobimail').data('lobiMail');
 ...
 * @returns {Object} "the same datasets object with filled options"
 */
